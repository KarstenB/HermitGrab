...
exec_contains "Destination is an existing file" $HG apply -y --profile testProfile
exec_contains "Symlink anotherfile.txt" $HG apply -y --profile testProfile --force
